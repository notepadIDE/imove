@ECHO OFF
ECHO ----------------------------------------------
ECHO.              robowizard v1-beta
ECHO ----------------------------------------------
ECHO.
ECHO Windows batch file interface for Windows robocopy utility.
ECHO.
...
:AINPUT4S
	...
	ECHO ----------------------------------------------
	ECHO.
	ECHO * Enter directories to exclude, separated by a space.
	ECHO.
...
:AINPUT6S
	...
	ECHO ----------------------------------------------
	ECHO.
	ECHO * Enter files to exclude, separated by a space.
	ECHO.
...
:QRUNS
	...
	robocopy C:\Users\%PROFILE%\Desktop %DESTINATION%\%COPYJOB%\Desktop /E /ETA /COPYALL /R:3 /W:10 
	robocopy C:\Users\%PROFILE%\Documents %DESTINATION%\%COPYJOB%\Documents /E /ETA /COPYALL /R:3 /W:10 
	robocopy C:\Users\%PROFILE%\Pictures %DESTINATION%\%COPYJOB%\Pictures /E /ETA /COPYALL /R:3 /W:10 
	robocopy C:\Users\%PROFILE%\Music %DESTINATION%\%COPYJOB%\Music /E /ETA /COPYALL /R:3 /W:10 
	robocopy C:\Users\%PROFILE%\Videos %DESTINATION%\%COPYJOB%\Videos /E /ETA /COPYALL /R:3 /W:10 
	ECHO.
	ECHO ----------------------------------------------
	ECHO.
...
:QRUND
	...
	ECHO ----------------------------------------------
	ECHO.
	robocopy %SOURCE%\Desktop C:\Users\%PROFILE%\Desktop /E /ETA /COPYALL /R:3 /W:10 
	robocopy %SOURCE%\Documents C:\Users\%PROFILE%\Documents /E /ETA /COPYALL /R:3 /W:10
	robocopy %SOURCE%\Pictures C:\Users\%PROFILE%\Pictures /E /ETA /COPYALL /R:3 /W:10 
	robocopy %SOURCE%\Music C:\Users\%PROFILE%\Music /E /ETA /COPYALL /R:3 /W:10  
	robocopy %SOURCE%\Videos C:\Users\%PROFILE%\Videos  /E /ETA /COPYALL /R:3 /W:10 
	ECHO.
	ECHO ----------------------------------------------
	ECHO.
...
:ARUNS
	...
	PAUSE
	robocopy %TARGET% %DESTINATION%%XDIRS_SWITCH%%XFILES_SWITCH% /E /ETA /COPYALL /R:3 /W:10 
	ECHO.
	ECHO ----------------------------------------------
	ECHO.
...
:END
	...
	ECHO ----------------------------------------------
	ECHO.
	ECHO robowizard service complete! (exiting...)
	ECHO.
	ECHO ----------------------------------------------
	ECHO.
	PAUSE
